  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 text-right flex flex-col items-end gap-4">
      <div className="hud-border bg-hud-bg p-4 rounded-sm min-w-[250px]">
        <div className="flex items-center justify-end gap-2 mb-4 border-b border-hud-blue/20 pb-2">
      ...
      <div className="flex gap-2">
        <button className="px-4 py-2 bg-hud-blue/10 border border-hud-blue/40 text-[10px] uppercase tracking-widest hover:bg-hud-blue/30 transition-all cursor-pointer pointer-events-auto">
          Join Raid
        </button>
        <button className="px-4 py-2 bg-red-500/10 border border-red-500/40 text-[10px] uppercase tracking-widest hover:bg-red-500/30 transition-all cursor-pointer pointer-events-auto">
          Emergency Signal
        </button>
      </div>
    </div>
