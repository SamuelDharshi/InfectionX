      ...
      <div className="relative w-full h-full overflow-hidden">
        <AnimatePresence>
          {zombies.map((zombie) => {
            ...
            const variantColors = [
              'border-hud-blue bg-hud-blue/20',
            ...
            return (
              <motion.div
                ...
                transition={{ 
                  type: 'tween',
                  ease: 'easeOut',
                  duration: zombie.isDead ? 0.8 : 0.25
                }}
              ...
              >
                ...
                >
                  ...
                  <div className={`relative ${zombie.type === 'Big' ? 'w-8 h-8' : 'w-5 h-5'} flex items-center justify-center`}>
                    <motion.div 
                      animate={{ 
                        scale: zombie.isAttacking ? 1.5 : 1.1,
                        opacity: zombie.isAttacking ? 1 : 0.6
                      }}
                      transition={{ repeat: Infinity, repeatType: 'reverse', duration: zombie.isAttacking ? 0.3 : 1.5 }}
                    ...
                    <motion.div 
                      ...
                      className="absolute left-0 right-0 h-px bg-white/50 z-10"
                    />
                  </div>
                  ...
                  <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 whitespace-nowrap bg-black/80 px-1 border border-hud-blue/20 text-[6px] uppercase tracking-tighter text-hud-blue">
                ...
                <div className="bg-black/90 border border-hud-blue/30 p-1 min-w-[80px] backdrop-blur-md">
                  ...
                  <div className="flex justify-between text-[6px] uppercase font-bold opacity-70 text-hud-blue/70">
                    <span>Threat</span>
